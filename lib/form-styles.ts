/**
 * Shared form input styles for consistent appearance across forms
 */
...
export const formContainerClassName =
  "rounded-lg border border-white/10 bg-white p-6";

export const formStatusClassName = {
  success: "rounded-lg p-4 text-sm bg-green-50 text-green-800",
  error: "rounded-lg p-4 text-sm bg-red-50 text-red-800",
};
