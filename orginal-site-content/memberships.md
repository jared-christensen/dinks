...
- **Courts per Day:** Up to 8
- **Cancellation Policy:** 24-hour
- **Special Access:** Early access to tournaments & events
- **Included:**
  - Personalized door code access
  - $10 ball machine rental
...
- **Booking Window:** 6 months (180 days) in advance
- **Courts per Day:** Up to 8
- **Cancellation Policy:** 8-hour
- **Special Access:** Early access to tournaments & events
- **Included:**
  - Personalized door code access
  - $10 ball machine rental
...
- **Benefits:**
  ...
  - Includes 1 VIP annual membership
- **Notes:** Sponsor provides banner per spec
...
- **Benefits:**
  ...
  - Logo on Dinks website for 1 year
  - Includes 1 VIP annual membership
- **Notes:** Mesh windscreen printing is sponsor responsibility
...
- All memberships are managed through CourtReserve
- CourtReserve handles court bookings, member accounts, and payments
